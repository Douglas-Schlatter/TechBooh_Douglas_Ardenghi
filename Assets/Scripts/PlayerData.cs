...
//Possibilita a criação de PlayerData no editor da unity
[CreateAssetMenu(fileName = "PlayerData", menuName = "PlayerData")] 
public class PlayerData : ScriptableObject
{
    //Relacionado ao nivel do jogo e score, eles serão usados como variaveis de controle no GameManager
    public int score = 0;
    public int level = 0;
